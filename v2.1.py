...
def recommend_tools(target, inputs, level):
    ...
    # --- Category: Email ---
        ...
        recommendations.append({
            ...
            "description": "Finds email address patterns, professional emails linked to companies, and verifies deliverability.",
            "type": "Freemium",
            "level": "Beginner (Web Only)",
            "url": "https://hunter.io/"
        })
    ...
    # --- Category: Phone ---
        ...
        recommendations.append({
            "name": "Truecaller",
            "category": "Caller ID & Name Lookup",
            "description": "Global crowd-sourced telephone directory to identify caller names, carrier, and basic spam reports.",
            "type": "Freemium",
            "level": "Beginner (Web Only)",
